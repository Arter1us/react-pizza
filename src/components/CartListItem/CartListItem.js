    ...
    return (
        <li className="cart-list__item">
            <div className="cart-list__info">
                <img className="cart-list__img" src={Pizza} alt="pizza" />
                <div className="cart-list__text">
                    <h2 className="cart-list__title">Сырный цыплёнок</h2>
                    <p className="cart-list__descr">тонкое тесто, 26 см.</p>
                </div>
            </div>
            <div className="cart-list__count">
                ...
                <p className="cart-list__number">2</p>
            ...
            <div className="cart-list__price">770 ₽</div>
